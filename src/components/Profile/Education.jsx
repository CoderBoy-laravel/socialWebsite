    ...
    if (file) {
      ...
      uploadString(storageRef, file, "data_url").then((snapshot) => {
        getDownloadURL(storageRef).then((downloadURL) => {
          set(dbRef(db, `education/${props.id}/${uuidv4()}`), {
            work: work ? work : "",
            ...
            get(child(dbRef(db), `education/${props.id}`))
              .then((snapshot) => {
                ...
                if (snapshot.val()) {
                  ...
                  setEducations(Object.entries(data));
                  props.educations(Object.entries(data));
                }
              })
              .catch((error) => {
                console.error(error);
  ...
  return (
    <>
      ...
      <div className="flex justify-between items-center">
        <p className="text-lg font-nunito font-bold">Education</p>
        {props.edit && (
